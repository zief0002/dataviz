...
```{r}
#| label: fig-bp-umn
#| fig-cap: "Boxplot of acceptance rates for the 33 institutions of higher learning in Minnesota. The border is colored using the secondary dark gold and the interior of the plot is filled with the primary maroon color for UMN."
#| fig-alt: "Boxplot of acceptance rates for the 33 institutions of higher learning in Minnesota. The border is colored using the secondary dark gold and the interior of the plot is filled with the primary maroon color for UMN."
#| out-width: "70%"
...
<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_03-03-01');">Show/Hide Solution</button>

<div id="exercise_03-03-01" style="display:none; margin: -40px 0 40px 40px;">
**R channel**
...
<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_03-03-02');">Show/Hide Solution</button>

<div id="exercise_03-03-02" style="display:none; margin: -40px 0 40px 40px;">
**R channel**
...
<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_03-03-03');">Show/Hide Solution</button>

<div id="exercise_03-03-03" style="display:none; margin: -40px 0 40px 40px;">
**R channel**
...
4. Use the *mn-colleges.csv* data to create a histogram of the acceptance rates. Color the interior of the bars using #CBA67B and the bar borders with #695645.

<button class="solution-btn solution-btn-default" onclick="toggle_visibility('exercise_03-03-04');">Show/Hide Solution</button>

<div id="exercise_03-03-04" style="display:none; margin: -40px 0 40px 40px;">
```{r}
#| label: fig-hist-umn
...
gf_histogram(~accept_rate, data = mn, color = "#695645", fill = "#CBA67B")
```
</div>
